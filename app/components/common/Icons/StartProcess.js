...
export default class StartProcess extends PureComponent<Props> {
	render() {
		return (
			<svg xmlns='http://www.w3.org/2000/svg' id='Capa_1' viewBox='0 0 232.153 232.153' width='18' height='18'>
				<path
