...
export default class Pipeline extends React.PureComponent<Props> {
  render() {
    return (
      <svg
      ...
      >
        <g fill={this.props.color}>
          ...
          <path d="M38.96,35.504h-1.216c-0.646,3.833-1.738,7.074-3.201,9.57l9.862,7.296V40.152C44.405,37.585,41.968,35.504,38.96,35.504 z" />
        </g>
      </svg>
    );
  }
